# Sentra Brand Foundation v1.0

**Status:** PRODUCTION / REVIEW

## Locked decisions
- Brand: **Sentra Artificial Intelligence**
...
- Primary accent: **Sentra Intelligence Blue #5B8CFF**

## Brand behavior
Black/white builds identity. Blue marks intelligence, interaction, selection, links, focus, and emphasis. The master logomark is not blue by default.

## Logo rules
- Never regenerate or redraw the master mark.
- Never stretch, rotate, outline, add glow/shadow, bevel, or gradient.
- Clear space: minimum **1X**, where X is the approximate width of one diagonal band.
- Minimum icon size: **16 px digital**, **6 mm print**.
