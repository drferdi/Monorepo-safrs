...
- Deployable applications live under `projects/<domain>/<capsule>/apps/*`, product-neutral shared capabilities under `packages/*`, and repository-wide tooling under `tools/*`; do not introduce root `apps/*` or `tooling/*` trees.
